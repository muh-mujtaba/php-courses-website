...
?>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      ?>
        <a class="nav-link" href="googlesinglecourse.php?course=<?php echo $row2['s_id'];?>" value="<?php echo $row2['s_id'];?>"><?php echo $row2['s_name'];?></a>
      </li>
      <?php
      }
    }
...
<?php
 // session_start();
  ...
  $sql1 = "SELECT * FROM bank
              ...
              $sql = "select *from vedio LEFT JOIN bank ON vedio.s_id = bank.s_id
              LEFT JOIN signup ON bank.user_id = signup.user_id
              where signup.user_id = '{$userid}'";
